...
\subsection{Risikoanalyse}
    ...
    \begin{tabular}{|p{0.3 \textwidth}|p{0.1 \textwidth}|p{0.1 \textwidth}|p{0.1 \textwidth}|p{0.1 \textwidth}|p{0.3 \textwidth}|}
    \hline
    Hendelse & Sansynlighet(1-9) & Innvirkning(1-9) & Viktighet (Sannsynlighet * Innvirkning) & Preventative tiltak & Reaktive tiltak \\ \hline
